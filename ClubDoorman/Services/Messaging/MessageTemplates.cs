    ...
    private readonly Dictionary<UserNotificationType, string> _userTemplates = new()
    {
        ...
        [UserNotificationType.CaptchaShown] = 
            ...
            [UserNotificationType.CaptchaWelcome] =
                "👋 {UserName}\n\n<b>Внимание!</b> Первые несколько сообщений проходят дополнительную антиспам-проверку: множественные эмодзи{mediaWarning}, просьбы \"писать в ЛС\" и реклама запрещены — при подозрении могут удаляться автоматически!"
        };
